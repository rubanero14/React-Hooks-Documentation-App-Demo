/*! For license information please see main.7d0e3c23.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      463: function (e, n, t) {
        ...
        function Ve(e, n, t, r, l, a, o, u, i) {
          (De = !1), (je = null), Ie.apply(Ae, arguments);
        }
        function Be(e) {
          var n = e,
            t = e;
        ...
        function Hn(e) {
          ...
          for (; 0 < On.length && null === (t = On[0]).blockedOn; )
            Fn(t), null === t.blockedOn && On.shift();
        }
              ...
              (function (e, n, t, r, l) {
                switch (n) {
                  ...
                  case "gotpointercapture":
                    return (
                      (a = l.pointerId),
                      Mn.set(a, jn(Mn.get(a) || null, e, n, t, r, l)),
                      !0
                    );
                }
                return !1;
        ...
        function Bl() {
          if (!Al && null !== Fl) {
            ...
            try {
              ...
              throw (null !== Fl && (Fl = Fl.slice(e + 1)), qe(Je, Bl), l);
            } finally {
              (wn = n), (Al = !1);
            }
          }
        ...
        var Va = {
          ...
          enqueueSetState: function (e, n, t) {
            ...
            (a.payload = n),
              ...
              null !== (n = Oa(e, a, l)) && (ts(n, e, l, r), Ia(n, e, l));
          },
          ...
          enqueueForceUpdate: function (e, n) {
            ...
            (l.tag = 2),
              ...
              null !== (n = Oa(e, l, r)) && (ts(n, e, r, t), Ia(n, e, r));
          },
        };
        ...
        function zu(e, n, t, r, l, a) {
          Cu(e, n);
          var o = 0 !== (128 & n.flags);
          if (!r && !o) return l && jl(n, t, !1), $u(e, n, a);
        ...
        function vs(e, n) {
          ...
          if ((ka(), (Pi = t), (Ei.current = r), null !== Li))
            throw Error(a(261));
        ...
        function Es(e, n, t) {
          ...
          null !== r && r.delete(n),
            ...
            zi === e &&
              (Ti & t) === t &&
              (4 === Oi ||
              (3 === Oi && (130023424 & Ti) === Ti && 500 > Ge() - Vi)
                ? ds(e, 0)
                : (Fi |= t)),
            rs(e, n);
        }
  ...
  !(function () {
    ...
    var f = "Card_card__XeFKL",
      d = t(184),
      p = function (e) {
        return (0, d.jsx)("div", {
          className: "".concat(f, " ").concat(e.className),
          children: e.children,
        });
      },
      m = "Button_button__Rzbpj",
      h = function (n) {
        return (0, d.jsxs)(e.Fragment, {
          children: [
            ...
            "link" !== n.type &&
              (0, d.jsx)("button", {
                type: n.type || "button",
                className: "".concat(m, " ").concat(n.className),
                onClick: n.onClick,
                disabled: n.disabled,
                title: n.title,
                children: n.children,
      ...
      g = function (n) {
        return (0, d.jsx)(e.Fragment, {
          children: (0, d.jsx)("svg", {
            ...
            viewBox: n.viewBox,
            children: (0, d.jsx)("path", { d: n.d }),
          }),
        });
      },
      y = "Input_control__y3AGP",
      b = "Input_invalid__hjAUG",
      w = e.forwardRef(function (n, t) {
        var r = (0, e.useRef)(),
          l = function () {
            r.current.focus();
          };
        return (
          ...
          (0, d.jsxs)("div", {
            className: "".concat(y, " ").concat(n.isValid ? b : ""),
            children: [
              (0, d.jsx)("label", { htmlFor: n.inputType, children: n.label }),
              (0, d.jsx)("input", {
                ref: r,
                type: n.inputType,
                id: n.inputType,
              ...
              n.validator && (0, d.jsx)("p", { children: n.validatorMessage }),
            ],
          })
        );
      }),
      k = { login: "Login_login__7DxHe", actions: "Login_actions__l3kxW" },
      S = e.createContext({
        isLoggedIn: !1,
        onLogout: function () {},
        ...
        (0, e.useEffect)(function () {
          "yes" === localStorage.getItem("login") &&
            ...
            localStorage.getItem("password") &&
              f(localStorage.getItem("password")));
        }, []);
        return (
          (0, e.useEffect)(
            function () {
          ...
          (0, d.jsx)(S.Provider, {
            value: {
              isLoggedIn: r,
              onLogout: function () {
                localStorage.setItem("login", "no"), l(!1);
              },
              onLogin: function (e, n) {
      ...
      P = function (n) {
        var t,
          r,
          l = a((0, e.useReducer)(N, C.login), 2),
          o = l[0],
          u = l[1],
          i = (0, e.useContext)(_),
          s = (0, e.useRef)(),
    ...
    var L = "ButtonList_buttonList__+9k5Z",
      T = function (e) {
        var n = e.lists,
          t = e.title,
          r = [t].concat(z(n));
                    ...
                    "li",
                    {
                      ...
                      children: [
                        ...
                        (0, d.jsx)(h, {
                          ...
                          href: e.href,
                          title:
                            "Link to official doc on learning " + e.btnContent,
                          children: (0, d.jsx)("code", {
                            children: e.btnContent,
                          }),
                        }),
                      ],
                    },
                ...
                return (
                  r.includes("-")
                    ? r.split("-").map(function (e) {
                        return (
                          (l += e[0].toUpperCase() + e.slice(1).toLowerCase()),
                          console.log((l = l[0].toLowerCase() + l.slice(1)))
                        );
                      })
                    : (l = r + "()"),
                  t.listData.push({
                    id: e.indexOf(r),
                    btnContent: "React Router Hooks" !== n ? l : l + "()",
                    href: a,
                    title: n,
                  }),
                  r
    ...
    (O.BASE_URL_1 = "https://react.dev/reference/react/"),
      (O.BASE_URL_2 = "https://react.dev/reference/react-dom/hooks/"),
      (O.BASE_URL_3 = "https://reactrouter.com/en/main/hooks/"),
      (O.listData = []),
      (O.setSourceUrl = function () {
        var e =
        ...
        switch (e) {
          case "React Hooks":
            O.MAIN_URL = O.BASE_URL_1;
            break;
          case "React Router Hooks":
            O.MAIN_URL = O.BASE_URL_3;
            break;
          default:
            O.MAIN_URL = O.BASE_URL_2;
        }
      });
    var I = function () {
        var n = (0, e.useContext)(_);
        return (
          (0, e.useEffect)(
            function () {
              0 === O.listData.length &&
                ...
                O.createNewList(["useFormStatus"], "React DOM Hooks"),
                O.createNewList(
                  [
                    "use-action-data",
                    "use-async-error",
          ...
          (0, d.jsxs)(p, {
            className: R,
            children: [
              (0, d.jsxs)("h1", { children: ["Welcome back ", n.name, "!"] }),
              (0, d.jsx)("br", {}),
              (0, d.jsx)("h2", {
                style: { fontWeight: "bold" },
                children: "Lets learn about React Hooks",
              }),
              (0, d.jsx)(T, { lists: O.listData, title: "React Hooks" }),
              (0, d.jsx)(T, { lists: O.listData, title: "React DOM Hooks" }),
              (0, d.jsx)(T, { lists: O.listData, title: "React Router Hooks" }),
              (0, d.jsx)("hr", {}),
              (0, d.jsxs)(h, {
      ...
      F = {
        "main-header": "MainHeader_main-header__XGd8e",
        rotate: "MainHeader_rotate__0BCgX",
        rotateX10: "MainHeader_rotateX10__LHK-7",
      },
      U = function () {
        return (0, d.jsxs)("header", {
          className: F["main-header"],
          children: [
            (0, d.jsxs)("h1", {
              children: [
                (0, d.jsx)("span", { children: "React Hooks \xa0" }),
                (0, d.jsx)(g, {
                  className: F["react-logo"],
                  viewBox: "0 0 512 512",
      ...
      A = function () {
        ...
        return (0, d.jsxs)(e.Fragment, {
          children: [
            ...
            (0, d.jsxs)("main", {
              children: [
                !n.isLoggedIn && (0, d.jsx)(P, {}),
                n.isLoggedIn && (0, d.jsx)(I, {}),
              ],
            }),
          ],
        });
    ...
    n.createRoot(document.getElementById("root")).render(
      (0, d.jsx)(x, { children: (0, d.jsx)(A, {}) })
    );
  })();
})();
//# sourceMappingURL=main.7d0e3c23.js.map
